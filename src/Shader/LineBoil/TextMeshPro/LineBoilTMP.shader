Shader "RaruLib/LineBoil/LineBoilTMP"
{
    Properties {
	...
	Pass {
		...
		pixel_t VertShader(vertex_t input)
		{
			...
			**************************************/
			// 頂点座標の移動量を計算
			float time = _Time.y;
			float swichDuration = 1 / _fps * 2;
			float swichTime = 1 / _fps;
			float nowSwichDuration = time % swichDuration;
			...
			float noiseFactor2 = noiseFactor1 * 2;	// -1～1の値に拡大
			float noiseFactor3 = noiseFactor2 - 1;	// -2～0に変更
